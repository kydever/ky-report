...
const getList = async () => {
    ...
    // let res = await globalProp.$api.getRoport(params)
    // tableData = res || [ {id: 1} ]
    data.tableData = [...[{
        id: 1, dt: "2022-03-21", items: [
            { project: "月食", module: "日报", summary: "sdadasdsadada", begin_time: "10:00", end_time: "19:00" },
            { project: "月食", module: "日报", summary: "sdadasdsadada", begin_time: "10:00", end_time: "19:00" },
            { project: "月食", module: "日报", summary: "sdadasdsadada", begin_time: "10:00", end_time: "19:00" },
            { project: "月食", module: "日报", summary: "sdadasdsadada", begin_time: "10:00", end_time: "19:00" },
        ]
...
const handleAction = (type: string, argu: any) => {
    ...
    switch (type) {
        ...
        case 'del':
            globalProp.$confirm('是否确定删除该日报', '提醒', {
